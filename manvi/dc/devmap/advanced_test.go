...
func TestAdvancedQueryPreservesProducerEnvelopeAndIndexContract(t *testing.T) {
	...
	c := fake(t, map[string]string{
		"explore": `{"definitions":{"items":[{"symbol_name":"Router"}],"resolution":"Available","shown":1,"total":9,"hidden":8,"truncated":true,"tokens_used":12},"blast_radius":{},"budget":{},"query":"Router","limit":20}`,
		"status":  status,
	})
