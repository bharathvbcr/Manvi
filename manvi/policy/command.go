...
func RedirectTargets(command string) ([]string, bool, error) {
	targets, opaque, err := redirectTargetsDeep(command, 0)
	if err != nil {
	...
	// Distinctness is the honest unit here anyway: the question the gate
	// answers is "may this file be written", and it has one answer per file.
