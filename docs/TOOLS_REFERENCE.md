...
| `devcouncil_write_file` | Write | `path` (string), `content` (string), `task_id` (string, optional) | Performs an atomic write passing the 6-rung policy gate. Requires active lease under strict posture. |
